...
import {
  getPublishedInterviewQuestions,
  setPublishStatus,
...
export default function InterviewQuestions() {
  ...
  const fetchQuestions = async (page = 1, limit = 20, search = "") => {
    try {
      setLoading(true);
      const res = await getPublishedInterviewQuestions({ page, limit, search });
  ...
  return (
    <div className="flex flex-col h-screen bg-white">
      ...
      <div className="px-5 h-16 flex justify-between items-center border-b border-gray-200">
        {/* LEFT: Title */}
        <p className="text-lg font-semibold">Interview Questions</p>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            <Link href="interview-questions/unpublished-questions">
              <Button variant="outline">Unpublished Questions</Button>
            </Link>
            <Link href="interview-questions/create">
                  ...
                  >
                    ...
                    <TableCell className="flex items-center gap-2">
                      ...
                      <Pencil
                        ...
                        onClick={(e) => togglePublish(q._id, q.isPublished, e)}
                      />
                    </TableCell>
