...
export default function Events() {
  ...
  const handleAddEvent = (newEvent: Omit<IEvent, "id">) => {
    const event: IEvent = {
      ...newEvent,
      id: Date.now(),
    };
        ...
        <div className="flex items-center gap-4">
          <Dialog open={isAddEventOpen} onOpenChange={setIsAddEventOpen}>
            <DialogTrigger asChild>
              <Button className="px-4 py-2 text-sm font-medium cursor-pointer flex items-center gap-2 bg-blue-600 hover:bg-blue-700">
                <Plus />
                Add Event
              </Button>
            </DialogTrigger>
            <DialogContent className="max-w-5xl sm:max-w-5xl md:max-w-5xl lg:max-w-5xl w-[95vw] sm:w-[800px] max-h-[90vh] overflow-y-auto">
              <DialogHeader>
                ...
                <div className="flex gap-3 pt-4">
                  ...
                  <Button
                    onClick={(e) => {
                      e.stopPropagation();
                      e.preventDefault();
                      router.push(`events/manage-events/${selectedEvent.id}`);
                    }}
                    variant="outline"
                ...
                <div className="flex items-center gap-2">
                  <Button
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      e.preventDefault();
                      router.push(`events/manage-events/${event.id}`);
                    }}
                  >
