...
export function WorkshopEventForm({
  ...
  React.useEffect(() => {
    const needsInitialization =
      ...
      !eventDetails.approvedEmail ||
      !eventDetails.waitlistEmail ||
      !eventDetails.eventVideoUrl;
    ...
    if (needsInitialization) {
      setEventDetails({
        ...
        approvedEmail: eventDetails.approvedEmail || {
          subject: "",
          emailEventName: "",
        },
        waitlistEmail: eventDetails.waitlistEmail || {
          subject: "",
          emailEventName: "",
          noOfSeats: 0,
        },
        eventVideoUrl: eventDetails.eventVideoUrl || {
          Link: "",
        },
      });
    }
    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          {/* Approved Email Fields */}
          <div className="space-y-2 pt-6">
            <h4 className="font-medium">Approved Email</h4>
            <div>
              <Label className="mb-2" htmlFor="approvedSubject">
                Subject
              </Label>
              <Input
                id="approvedSubject"
                value={eventDetails.approvedEmail?.subject || ""}
                onChange={(e) =>
                  handleNestedChange("approvedEmail", "subject", e.target.value)
                }
                placeholder="Approved Email Subject"
              />
            </div>
            <div>
              <Label className="mb-2" htmlFor="approvedEventName">
                Email Event Name
              </Label>
              <Input
                id="approvedEventName"
                value={eventDetails.approvedEmail?.emailEventName || ""}
                onChange={(e) =>
                  handleNestedChange(
                    "approvedEmail",
                    "emailEventName",
                ...
                placeholder="Approved Event Name"
              />
            </div>
          </div>

          {/* Waitlist Email Fields */}
          <div className="space-y-2 pt-6">
            <h4 className="font-medium">Waitlist Email</h4>
            <div>
              <Label className="mb-2" htmlFor="waitlistSubject">
                Subject
              </Label>
              <Input
                id="waitlistSubject"
                value={eventDetails.waitlistEmail?.subject || ""}
                onChange={(e) =>
                  handleNestedChange("waitlistEmail", "subject", e.target.value)
                }
                placeholder="Waitlist Email Subject"
              />
            </div>
            <div>
              <Label className="mb-2" htmlFor="waitlistEventName">
                Email Event Name
              </Label>
              <Input
                id="waitlistEventName"
                value={eventDetails.waitlistEmail?.emailEventName || ""}
                onChange={(e) =>
                  handleNestedChange(
                    "waitlistEmail",
                    "emailEventName",
                ...
                placeholder="Waitlist Event Name"
              />
            </div>
            <div>
              <Label className="mb-2" htmlFor="waitlistEventName">
              ...
              <Input
                id="waitlistEventName"
                value={eventDetails.waitlistEmail?.noOfSeats || ""}
                onChange={(e) =>
                  handleNestedChange(
                    "waitlistEmail",
                    "noOfSeats",
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div>
            <Label className="mb-2" htmlFor="eventVideoUrl">
              Video Url
            </Label>
            <Input
              id="eventVideoUrl"
              value={eventDetails.eventVideoUrl?.Link || ""}
              onChange={(e) =>
                handleNestedChange("eventVideoUrl", "Link", e.target.value)
              }
