...
(function assertConfig() {
  ...
  if (process.env.NODE_ENV === "production" && !process.env.PUBLIC_FORM_URL) {
...
const rateLimitDisabled =
  process.env.ONBOARDING_RATELIMIT_DISABLED === "true" &&
