 ...
 *
 * Small on purpose. The one thing worth care here is delete: the FK is
 ...
 */
const reorderCategories = asyncWrapper(async (req, res) => {
  const { ids } = req.body ?? {};
...
const deleteCategory = asyncWrapper(async (req, res) => {
  ...
  const affected = await Recording.count({
