...
const ACCESS_TOKEN_TTL = psEnv.COMPANY_ACCESS_TTL || "1h";
const REFRESH_TOKEN_TTL = psEnv.COMPANY_REFRESH_TTL || "30d";
...
const inviteUser = async (req, res) => {
  try {
    ...
    const inviteLink = `${psEnv.ADMIN_FRONTEND_URL}/auth/invite?token=${token}`;
